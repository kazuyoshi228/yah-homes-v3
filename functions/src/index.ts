...
async function buildLifecycleMail(
  ...
  return {
    ...
    text: [
      ...
      myPage, "",
      "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）",
    ].join("\n"),
    html,
  };
}
...
async function buildContactReply(lang: string, name: string, message: string, inquiryLink = ""): Promise<{ subject: string; text: string; html: string }> {
  ...
  return {
    ...
    text: [
      ...
      CL.note, "", "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）",
    ].join("\n"),
    html: mailHtml({
      heading: CL.heading,
...
const MAIL_L10N: Record<string, Record<string, string>> = {
  ja: {
    ...
    footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）",
  },
  en: {
...
const CANCEL_L10N: Record<string, Record<string, string>> = {
  ja: { subject: "【yah.homes】ご予約をキャンセルしました", greetSuffix: " 様", bookingNo: "予約番号",
    ...
    cta: "空室を見る", contact: "ご不明な点は My Page のメッセージからご連絡ください。", footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）" },
  en: { subject: "[yah.homes] Your booking has been cancelled", greetSuffix: "", bookingNo: "Booking ID",
    ...
    cta: "See availability", contact: "If you have any questions, message us from My Page.", footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）" },
  ko: { subject: "[yah.homes] 예약이 취소되었습니다", greetSuffix: " 님", bookingNo: "예약번호",
    ...
    cta: "빈방 보기", contact: "궁금하신 점은 My Page 메시지로 연락해 주세요.", footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）" },
  zh: { subject: "【yah.homes】您的預訂已取消", greetSuffix: " 您好", bookingNo: "預訂編號",
    ...
    cta: "查詢空房", contact: "如有任何問題，請透過 My Page 訊息與我們聯繫。", footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）" },
  th: { subject: "[yah.homes] ยกเลิกการจองของคุณแล้ว", greetSuffix: "", bookingNo: "หมายเลขการจอง",
    ...
    cta: "ดูห้องว่าง", contact: "หากมีคำถาม กรุณาติดต่อเราผ่านข้อความใน My Page", footer: "yah.homes ／ ボンファイア株式会社（Bonfire Inc.）" },
};
