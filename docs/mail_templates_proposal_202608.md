...
### ① 高砂のチェックイン案内が清川のまま（**最優先**）

マニュアルURL `sites.google.com/view/kiyokawa-yah/`、Google マップの座標、キーボックス番号 `2345` が、高砂のテンプレートにも清川のものが入っている。**高砂のお客様に清川の入室方法を送っている。** 正しい値の提供が必要。
...
1. **高砂の正しい値** — マニュアルURL・Google マップ・キーボックス番号
