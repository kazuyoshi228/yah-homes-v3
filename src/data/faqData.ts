    ...
    categories: [
      {
        ...
        items: [
          ...
          {
            q: "福岡市中心（市區）有包棟民宿嗎？",
            a: "有。yah.homes 是位於福岡市中心（中央區）的包棟別墅：清川（中央區清川・最多{kcap}人・{krooms}間臥室・開車到天神約8分鐘）與高砂（中央區高砂・最多{tcap}人・渡邊通站步行{tstation}分鐘）。兩棟皆採密碼鎖無接觸自助入住，步行可達中洲、博多運河城、柳橋連合市場。",
          },
          {
            q: "每晚房價多少？在哪裡預訂？",
