        ...
        items: [
          {
            ...
            a: "チェックイン: 16:00〜（時間の制限はありません）／ チェックアウト: 10:00まで。",
          },
          {
            q: "セルフチェックインはできますか？",
        ...
        items: [
          {
            ...
            a: "Check-in: from 4:00 PM (no time limit). Check-out: by 10:00 AM.",
          },
          {
        ...
        items: [
          {
            ...
            a: "체크인: 오후 4시부터 (시간 제한 없음). 체크아웃: 오전 10시까지. 얼리 체크인/레이트 체크아웃은 사전 문의 주세요.",
          },
          {
            q: "셀프 체크인이 가능한가요?",
    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          {
            q: "入住和退房時間是什麼時候？",
            a: "入住：下午4點起（無時間限制）。退房：上午10點前。如需提前入住或延遲退房，請提前聯繫我們。",
          },
          {
            q: "可以自助入住嗎？",
        ...
        items: [
          {
            ...
            a: "เช็คอิน: ตั้งแต่ 16:00 น. (ไม่จำกัดเวลา) เช็คเอาท์: ก่อน 10:00 น. สำหรับเช็คอินก่อนกำหนดหรือเช็คเอาท์ช้า กรุณาติดต่อล่วงหน้า",
          },
          {
