...
export const takasagoData: Record<Lang, TakasagoTranslations> = {
  en: {
    ...
    checkin: {
      ...
      time: "Check-in: from 4:00 PM (no time limit)",
    ...
    houseRules: {
      ...
      items: [
        ...
        { icon: "checkin-time", rule: "Check-in: from 4:00 PM (no time limit). Check-out: by 10:00 AM." },
  ...
  ja: {
    ...
    conditions: {
      title: "ご予約条件",
      cancellation: "キャンセル：チェックイン日の8日前まで無料。正確な期限（日本時間）はご予約時に表示します。",
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "キャンセルポリシーを教えてください。",
          a: "公式サイトからのご予約は、チェックイン日の8日前まで無料でキャンセルいただけます。期限を過ぎた場合と無連絡不泊の場合は宿泊料金の全額を申し受けます。正確な期限（日本時間）は決済前の画面と確定メールに表示し、キャンセルは My Page からお客様ご自身で行えます。日程・人数・棟の変更をご希望の場合は、一度キャンセルのうえ、あらためてご予約ください（無料期間内であれば追加のご負担はありません）。Airbnb・Booking.com 経由のご予約は、各サービスのポリシーが適用されます。",
        },
        {
          q: "足腰に不安があっても利用できますか？",
    ...
    houseRules: {
      ...
      items: [
        ...
        { icon: "checkin-time", rule: "チェックイン：16:00〜（時間の制限はありません）／チェックアウト：10:00まで。" },
  ...
  ko: {
    ...
    conditions: {
      title: "예약 조건",
      cancellation: "취소 정책: 체크인 8일 전까지 무료. 정확한 기한(일본 시간)은 예약 시 표시됩니다.",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "취소 정책은 어떻게 되나요?", a: "공식 사이트 예약은 체크인 8일 전까지 무료로 취소하실 수 있습니다. 기한이 지난 경우와 무단 미투숙의 경우에는 숙박 요금 전액을 청구합니다. 정확한 기한(일본 시간)은 결제 전 화면과 확정 메일에 표시되며, 취소는 My Page에서 직접 하실 수 있습니다. 날짜·인원·객실 변경을 원하시면 취소 후 다시 예약해 주세요(무료 기간 내라면 추가 부담은 없습니다). Airbnb·Booking.com 예약은 각 서비스의 정책이 적용됩니다." },
    ...
    houseRules: {
      ...
      items: [
        ...
        { icon: "checkin-time", rule: "체크인: 오후 4:00부터 (시간 제한 없음). 체크아웃: 오전 10:00 이전." },
  ...
  zh: {
    ...
    conditions: {
      title: "預訂條件",
      cancellation: "取消政策：入住日 8 天前可免費取消。確切期限（日本時間）將於預訂時顯示。",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "取消政策是什麼？", a: "透過官網預訂者，可於入住日 8 天前免費取消。逾期取消及未告知未入住者，將收取全額住宿費。確切期限（日本時間）會顯示於付款前畫面與確認信中，並可自行於 My Page 取消。如需變更日期、人數或房型，請先取消再重新預訂（於免費期限內不會產生額外費用）。透過 Airbnb、Booking.com 的預訂則適用各平台政策。" },
    ...
    houseRules: {
      ...
      items: [
        ...
        { icon: "checkin-time", rule: "入住：下午 4:00 起（無時間限制）。退房：上午 10:00 前。" },
  ...
  th: {
    ...
    checkin: {
      ...
      time: "เช็คอิน: ตั้งแต่ 16:00 น. (ไม่จำกัดเวลา)",
    ...
    conditions: {
      ...
      cancellation: "นโยบายยกเลิก: ยกเลิกฟรีถึง 8 วันก่อนเช็คอิน กำหนดเวลาที่แน่นอน (เวลาญี่ปุ่น) จะแสดงตอนจอง",
    ...
    faq: {
      ...
      items: [
        ...
        { q: "นโยบายยกเลิกเป็นอย่างไร?", a: "การจองผ่านเว็บไซต์ทางการ ยกเลิกฟรีได้ถึง 8 วันก่อนวันเช็คอิน หลังจากนั้นและกรณีไม่มาพักโดยไม่แจ้ง จะคิดค่าที่พักเต็มจำนวน กำหนดเวลาที่แน่นอน (เวลาญี่ปุ่น) จะแสดงก่อนชำระเงินและในอีเมลยืนยัน และท่านสามารถยกเลิกเองได้จาก My Page หากต้องการเปลี่ยนวันที่ จำนวนคน หรือหลังที่พัก กรุณายกเลิกแล้วจองใหม่ (ภายในระยะเวลาฟรีจะไม่มีค่าใช้จ่ายเพิ่ม) ส่วนการจองผ่าน Airbnb และ Booking.com เป็นไปตามนโยบายของแพลตฟอร์มนั้น" },
    ...
    houseRules: {
      ...
      items: [
        ...
        { icon: "checkin-time", rule: "เช็คอิน: ตั้งแต่ 16:00 น. (ไม่จำกัดเวลา) เช็คเอาท์: ก่อน 10:00 น." },
