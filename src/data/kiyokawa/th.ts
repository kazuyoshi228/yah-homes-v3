  ...
  propertyDescription: {
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "ครัวครบครันพร้อมตู้เย็นขนาดใหญ่และอุปกรณ์ทำครัวมากมาย ให้คุณทำอาหารด้วยวัตถุดิบสดใหม่จากท้องถิ่น โต๊ะทำงานส่วนตัวและ Wi-Fi ความเร็วสูงเหมาะสำหรับ workcation ในเดือนเมษายน 2569 ติดตั้งเครื่องซักอบผ้าดรัมรุ่นใหม่\n\nที่จอดรถส่วนตัวฟรี ({pk} คัน) รวมอยู่ในราคา\n\n[ประกาศจากเจ้าของ]\nเมษายน 2569: เปลี่ยนเครื่องซักผ้าเป็นเครื่องซักอบผ้าดรัม กดปุ่มเดียวครบทั้งซักและอบ",
      },
    ],
    bedroomGuide: {
      title: "แนะนำห้องนอน",
    ...
    otherNotes: {
      ...
      items: [
        ...
        "หากจำนวนผู้เข้าพักเกินกว่าที่แจ้งไว้ จะเรียกเก็บ ¥{xfee} ต่อคนที่เกิน",
