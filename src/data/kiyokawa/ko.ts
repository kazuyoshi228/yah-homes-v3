...
export const ko: KiyokawaTranslations = {
  ...
  propertyDescription: {
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "{tv}인치 {tv}인치 대형 TV와 일본제 고품질 앰프, 플로어형 스피커를 설치했습니다. 영화관 수준의 음향으로 영화와 동영상을 즐기세요. (각종 스트리밍 서비스는 본인 계정으로 로그인하여 이용하세요)",
      },
      {
        title: "3. '살듯이 여행하는' 충실한 설비",
        body: "대형 냉장고와 풍부한 조리도구를 갖춘 넓은 풀 키친 완비. 현지 신선 식재료로 요리를 즐기실 수 있습니다. 전용 업무 데스크(1인용)와 고속 Wi-Fi도 갖추고 있어 워케이션에도 최적입니다. 2026년 4월에는 건조 기능이 있는 최신 드럼식 세탁기를 도입했습니다.\n\n전용 주차장({pk}대)도 무료로 이용 가능합니다.\n\n[오너 공지]\n2026년 4월: 세탁기를 드럼식 세탁건조기로 교체. 버튼 하나로 세탁부터 건조까지 완료됩니다.",
      },
    ],
    bedroomGuide: {
      title: "침실 안내",
    ...
    otherNotes: {
      ...
      items: [
        ...
        "예약 시 신고한 인원을 초과하여 숙박하실 경우 초과 1인당 ¥{xfee}의 추가 요금이 부과됩니다.",
  ...
  floorPlan: {
    title: "평면도",
    subtitle: "{floors}층 단독 주택 · 1F: 욕실 & 차고 · 2F: 거실/식당/주방 · 3F: 침실 {rooms}개 & 발코니",
