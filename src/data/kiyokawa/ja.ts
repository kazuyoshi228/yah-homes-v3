...
export const ja: KiyokawaTranslations = {
  ...
  access: {
    ...
    items: [
      ...
      { from: "渡辺通駅（1番出口）", time: "徒歩{station}分" },
  ...
  conditions: {
    ...
    extraGuest: "追加人数料金: {bg}名まで同一料金・{bgx}名目以降1名につき¥{xfee}/泊",
  ...
  propertyDescription: {
    ...
    otherNotes: {
      ...
      items: [
        ...
        "申告人数を超えてご宿泊された場合、超過1名につき¥{xfee}の追加料金を申し受けます。",
