...
export const ja: KiyokawaTranslations = {
  ...
  floorPlan: {
    title: "間取り",
    subtitle: "3階建て一軒家 · 1階: バスルーム・ガレージ · 2階: リビング/ダイニング/キッチン · 3階: 寝室{rooms}室・バルコニー",
