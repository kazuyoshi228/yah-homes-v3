// takasago の th 版。言語ごとに分けているのは、1ファイル1,800行だと
...
export const th: TakasagoTranslations = {
  ...
  propertyDescription: {
    ...
    showLess: "ย่อ",
    intro: "ที่พักแบบเช่าทั้งหลังสไตล์ทันสมัยในย่านทากาซาโกะที่คึกคักของชูโอะ-กุ ฟุกุโอกะ ตั้งอยู่ในระยะเดินจากเทนจิน ให้คุณเพลิดเพลินกับความสะดวกของใจกลางฟุกุโอกะและความสบายของบ้านส่วนตัว\n\nขับรถไปเทนจิน {tenjinCar} นาที ขับรถไปสถานีฮากาตะ {hakataCar} นาที ขับรถจากสนามบิน 20 นาที เช็คอินด้วยตัวเองแบบไม่ต้องพบใคร เพื่อการพักผ่อนที่เป็นส่วนตัวอย่างสมบูรณ์\n\nเหมาะสำหรับครอบครัวหรือกลุ่มเพื่อนสูงสุด {cap} คน ห้องนั่งเล่นกว้างขวาง ห้องโฮมเธียเตอร์ และเฟอร์นิเจอร์ดีไซน์สวยงาม สร้างประสบการณ์พิเศษที่น่าจดจำ",
    highlights: [
      {
      ...
      },
      {
        ...
        body: "เพลิดเพลินกับห้องโฮมเธียเตอร์ที่มีทีวีจอใหญ่ {tv} นิ้ว เหมาะสำหรับคืนภาพยนตร์กับกลุ่มของคุณ",
      },
      {
  ...
  floorPlan: {
    title: "ผังพื้น",
    subtitle: "บ้านเดี่ยว 3 ชั้น · ชั้น 1: ทางเข้า & โรงรถ · ชั้น 2: ห้องนั่งเล่น/ห้องอาหาร/ครัว, โฮมเธียเตอร์, ห้องอาบน้ำ & ฝักบัว · ชั้น 3: {rooms} ห้องนอน & ระเบียง",
    imageAlt: "ผังพื้นทากาซาโกะ – ชั้น 1 ทางเข้า & โรงรถ, ชั้น 2 ห้องนั่งเล่น/ห้องอาหาร/ครัว, โฮมเธียเตอร์, ห้องอาบน้ำ & ฝักบัว, ชั้น {rooms} ห้องนอน & ระเบียง",
  },
  contact: {
    title: "มีคำถามไหม?",
