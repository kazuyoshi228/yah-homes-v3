...
export const ko: TakasagoTranslations = {
  ...
  propertyDescription: {
    ...
    otherNotes: {
      ...
      items: [
        ...
        "신고 인원 초과 시 초과 인원 1인당 ¥{xfee}의 추가 요금이 부과됩니다.",
  ...
  floorPlan: {
    title: "평면도",
    subtitle: "{floors}층 단독 주택 · 1층: 현관 & 차고 · 2층: 거실/식당/주방, 시어터 룸, 욕실 & 샤워 부스 · {floors}층: 침실 {rooms}개 & 발코니",
    imageAlt: "다카사고 평면도 – 1층 현관 & 차고, 2층 거실 식당 주방, 시어터 룸, 욕실 & 샤워 부스, {floors}층 침실 & 발코니",
  },
  contact: {
    title: "질문이 있으신가요?",
